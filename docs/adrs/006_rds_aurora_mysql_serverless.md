# ADR-006 : RDS Aurora MySQL Serverless for actual cloud environment DB
Created : 23-Mar-2023
## Status
ACCEPTED
## Context
...
## Decision
We decided to use Aurora MySQL Serverless as our underlying engine in AWS Cloud due to the following reasons:
...
4. Limitations with MySQL versions that can be used freely, as only some are provided in Serverless setup.